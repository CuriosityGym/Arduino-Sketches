...
BLYNK_WRITE(V0)
{
  ...
  do { u8g.setFont(u8g_font_timB10);
      u8g.drawStr(1,10,"Youtube Subscribers:");
...
void getSubscriberCount()
{
  ...
  //Blynk.virtualWrite(V0, "https://api.sunrise-sunset.org/json?lat=50.4495484&lng=30.5253873&date=2016-10-01");
   ...
   Blynk.virtualWrite(V0, "https://api.thingspeak.com/apps/thinghttp/send_request?api_key=2J2UYWIDFW1SAID2");
...
void setup()
{
  ...
  timer.setInterval(300000L, getSubscriberCount);
