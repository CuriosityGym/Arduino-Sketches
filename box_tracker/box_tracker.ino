...
int new_package()
   { 
      ...
      if(light_value < light_threshold && packageArrived == false)    //if there is change in light value (New Package)
        { 
          sprintf(buff, "/trigger/new_package/with/key/cDlIAZcApEGZiZDeOIXExA");
        ...
        delay(2000);
     if(light_value > light_threshold && packageArrived == true)
       {
