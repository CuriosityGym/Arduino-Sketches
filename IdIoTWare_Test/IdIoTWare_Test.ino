     ...
     for(int i=0; i<3; i++)
        {
          switch(i)
               { 
                case 0: strip.setPixelColor(0,175,0,0);strip.show();
                Serial.println("Red Color");
                showMessageOnLcd(50,17," RED",35,45,"Color");
                delay(ws2812_delay);break;
                case 1: strip.setPixelColor(0,0,175,0);strip.show();
                Serial.println("Green Color");
                showMessageOnLcd(35,17," GREEN",35,45,"Color");
                delay(ws2812_delay);break;
                case 2: strip.setPixelColor(0,0,0,175);strip.show();
                Serial.println("Blue Color");
                showMessageOnLcd(40,17," BLUE",35,45,"Color");
                delay(ws2812_delay); break;
               }
         } 
    delay(1000);
...
void button1_TEST()
    {  
      ...
      delay(2000);
      while(82000>millis() && Button1Pressed < 3)
           {
            ...
            if(Button1State==HIGH && Button1LastState==LOW)
              {
               ...
               u8g.firstPage();
           do {  
                u8g.drawStr( 5, 15, "button1 pressed");
      ...
      while(103000 >millis() && touched < 3)
           {
             ...
             if(touchPadState == HIGH && touchPadLastState == LOW)
               { 
                 ...
                 u8g.firstPage();
                 do {  
                     u8g.drawStr( 5, 15, "touchpad touched");
                     u8g.setPrintPos(50, 40);
                     u8g.print(touched);
                    } while( u8g.nextPage() );
	        }
...
void IR_TEST() 
    { 
      ...
      delay(2000);
      while(124000>millis() && recieved_code < 4) 
           {
